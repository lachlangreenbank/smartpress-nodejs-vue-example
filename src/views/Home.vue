<template>
  <span>
    <div class="home">
      <img alt="Smartpress logo" src="../assets/logo.png">
    </div>
    ...
    <div>  
      ...
      <span v-if="balance.data" :key="balance.data.data.user_id">Balance: {{balance.data.data}}</span><br/><br/><br/><br/>
      <span v-if="create.data" :key="create.data.data.user_id">Create: {{create.data.data}}</span><br/><br/><br/><br/>
      <span v-if="send.data" :key="send.data.data.user_id">Send: {{send.data.data}}</span><br/><br/><br/><br/>
    </div>
  </span>
</template>
